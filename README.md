...
3. Connect via SSH to `lab-control`, for user and password check:[Operations guide](docs/OPERATIONS.md).
...
Compare the resulting SHA-256 value of the downloaded .ova file with the value stored in the accompanying .sha256 file before importing the OVA. The SHA-256 values ​​can be generated by navigating to the folder where you downloaded the .ova file and running the following command:
